  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <a href="./vistas/vistaBicis.php"><img src="./images/carousel2.jpeg" class="d-block w-100 rounded" alt="..."></a>
    ...
    <ul class="d-flex justify-content-center">
      <li class="booking-card" style="background-image: url(./images/bujes.png)">
        <div class="book-container">
          <div class="content">
            <button class="btn"><a href="./vistas/vistaComponentes.php" class="text-white">Comprar</a></button>
          </div>
        </div>
      ...
      <li class="booking-card" style="background-image: url(./images/bizzis.png);">
        <div class="book-container">
          <div class="content">
            <button class="btn"><a href="./vistas/vistaEquipacion.php" class="text-white">Comprar</a></button>
          </div>
        </div>
        <div class="informations-container">
