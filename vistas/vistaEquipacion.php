...
<body>
                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Equipación</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container" style="background-color: #eee;">
        ...
        <div class="row" id="panel">
            ...
            if ($seleccion = mysqli_query($conexion, "SELECT * FROM productos WHERE tipoProducto = 'equipacion'")) {
                    ...
                    <div class="row">
                        <div class="col">
                            <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="./vistaEquipacion.php">Equipación</a></li>
