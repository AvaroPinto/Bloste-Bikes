    ...
    <div class="container" style="width: 70%;">
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
                ...
                <div class="container">
                    ...
                    <a class="navbar-brand me-2" href="#">
                        <img src="../images/navLogo.png" height="100" alt="MDB Logo" loading="lazy" style="margin-top: -1px; border-radius: 10px;" />
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarButtonsExample">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="../panelAdmin.php">Estadísticas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../vistas/insertAdmin.php">Insertar Productos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../vistas/comprasAdmin.php">Compras</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../vistas/adminUser.php">Usuarios</a>
                            </li>
                        </ul>
                        <!-- Left links -->
                        <?php
            ...
            <a class='btn btn-danger px-3 me-2' href='../cerrarSesion.php' role='button'><i class='fa-solid fa-door-open'></i></a>
                        ...
                        ?>
                        <div class="d-flex align-items-center">
                            <a class="btn btn-dark px-3" href="https://github.com/avaropinto" role="button"><i class="fab fa-github"></i></a>
                        </div>
                    </div>
                    <!-- Collapsible wrapper -->
                </div>
